...
type ReceivedPacketHandler interface {
	...
	ReceivedPacket(pn protocol.PacketNumber, ecn protocol.ECN, encLevel protocol.EncryptionLevel, rcvTime time.Time, isAckEliciting, forceAck bool) error
	HandleAckFrequencyFrame(frame *wire.AckFrequencyFrame)
	DropPackets(protocol.EncryptionLevel)
